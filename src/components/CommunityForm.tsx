...
const CommunityForm: React.FC = () => {
  ...
  const saveSubmission = (data: z.infer<typeof formSchema>) => {
    ...
    localStorage.setItem('communitySubmissions', JSON.stringify([...existingSubmissions, newSubmission]));
  };
  ...
  return <section id="community-form" className="py-16 bg-qarawin-black relative">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  field
                        ...
                        <FormControl>
                          <Input placeholder="Your name" {...field} className="border border-qarawin-red/20 bg-qarawin-black/50 text-qarawin-cream h-9" />
                        </FormControl>
                  ...
                  field
                        ...
                        <FormControl>
                          <Input placeholder="Your email address" type="email" {...field} className="border border-qarawin-red/20 bg-qarawin-black/50 text-qarawin-cream h-9" />
                        </FormControl>
                        <FormMessage className="text-xs" />
                      </FormItem>} />
                </div>
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="LinkedIn / GitHub / Google Scholar" {...field} className="border border-qarawin-red/20 bg-qarawin-black/50 text-qarawin-cream h-9" />
                      </FormControl>
                      <FormMessage className="text-xs" />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <Textarea placeholder="Tell us a bit about yourself and your background" {...field} className="min-h-24 border border-qarawin-red/20 bg-qarawin-black/50 text-qarawin-cream resize-none" />
                      </FormControl>
                      <FormMessage className="text-xs" />
                    </FormItem>} />
                <Button type="submit" className="w-full bg-qarawin-red hover:bg-qarawin-red/90 text-white font-medium py-2 px-4 rounded-md transition-all" disabled={isSubmitting}>
