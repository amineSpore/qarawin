    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="mb-6 opacity-80 mx-auto w-24 h-24 rounded-full border-2 border-qarawin-red/30 overflow-hidden animate-fade-in opacity-0 flex items-center justify-center" style={{ animationDelay: '0.1s' }}>
            <div className="bg-[url('/lovable-uploads/5a702ca1-ebc0-43ae-8ff4-4edb97822db5.png')] bg-center bg-cover w-full h-full scale-150 opacity-90 filter saturate-50"></div>
          </div>
      ...
      <div className="absolute top-10 left-10 w-32 h-32 border-t-2 border-l-2 border-qarawin-red/20 rounded-tl-lg hidden md:block"></div>
      <div className="absolute bottom-10 right-10 w-32 h-32 border-b-2 border-r-2 border-qarawin-red/20 rounded-br-lg hidden md:block"></div>
    </section>
  );
};
